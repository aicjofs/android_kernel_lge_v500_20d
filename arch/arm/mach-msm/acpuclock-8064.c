...
static struct acpu_level tbl_PVS0_1700MHz[] __initdata = {
	...
	{ 1, {   216000, HFPLL, 2, 0x10 }, L2(0),   887500 },
	{ 1, {   270000, HFPLL, 2, 0x14 }, L2(0),   887500 },
	{ 1, {   324000, HFPLL, 2, 0x18 }, L2(0),   912500 },
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(0),   912500 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(1),   937500 },
#else
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   937500 },
#endif
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   937500 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(6),   937500 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(15),   950000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(15),   987500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(15),   990000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(15),  1025000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(15), 1062500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(15), 1075000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(15), 1112500 },
...
static struct acpu_level tbl_PVS1_1700MHz[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(15),   987500 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(15),  1000000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(15), 1025900 },
	...
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(15), 1187500 },
#ifdef CONFIG_CPU_OVERCLOCK
...
static struct acpu_level tbl_PVS2_1700MHz[] __initdata = {
	...
	{ 1, {   216000, HFPLL, 2, 0x10 }, L2(0),   862500 },
	{ 1, {   270000, HFPLL, 2, 0x14 }, L2(0),   862500 },
	{ 1, {   324000, HFPLL, 2, 0x18 }, L2(0),   887500 },
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(0),   887500 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(1),   912500 },
#else
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   912500 },
#endif
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   912500 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(6),   912500 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(15),   912500 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(15),   925000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(15),   937500 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(15),   962500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(15),  987500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(15), 1000000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(15), 1025000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(15), 1062500 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(15), 1087500 },
...
static struct acpu_level tbl_PVS3_1700MHz[] __initdata = {
	...
	{ 1, {   216000, HFPLL, 2, 0x10 }, L2(0),   837500 },
	{ 1, {   270000, HFPLL, 2, 0x14 }, L2(0),   837500 },
	{ 1, {   324000, HFPLL, 2, 0x18 }, L2(0),   862500 },
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(0),   862500 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(1),   887500 },
#else
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   887500 },
#endif
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   887500 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(6),   887500 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(15),   887500 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(15),   887500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(15),   912500 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(15),   937500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(15),  962500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(15),  975000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(15),  987500 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(15), 1025000 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(15), 1050000 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(15), 1087500 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(15), 1112500 },
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(15), 1112500 },
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(14), 1137500 },
...
static struct acpu_level tbl_PVS4_1700MHz[] __initdata = {
#ifdef CONFIG_LOW_CPUCLOCKS
	{ 1, {   162000, HFPLL, 2, 0x0C }, L2(0),   812500 },
	{ 1, {   216000, HFPLL, 2, 0x10 }, L2(0),   812500 },
	{ 1, {   270000, HFPLL, 2, 0x14 }, L2(0),   812500 },
	{ 1, {   324000, HFPLL, 2, 0x18 }, L2(0),   837500 },
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(0),   837500 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(1),   862500 },
#else
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   862500 },
#endif
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   862500 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(6),   862500 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(15),   862500 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(15),   875000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(15),   887500 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(15),   912500 },
	...
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(15), 1087500 },
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(15), 1087500 },
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(14), 1112500 },
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(14), 1137500 },
	{ 1, {  1944000, HFPLL, 1, 0x48 }, L2(14), 1162500 },
	{ 1, {  1998000, HFPLL, 1, 0x4A }, L2(14), 1187500 },
	{ 1, {  2052000, HFPLL, 1, 0x4C }, L2(14), 1212500 },
	{ 1, {  2106000, HFPLL, 1, 0x4E }, L2(14), 1237500 },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS5_1700MHz[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(15),   887500 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(15),   912500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(15),  925000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(15),  937500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(15),  950000 },
	...
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(14), 1112500 },
...
static struct acpu_level tbl_PVS6_1700MHz[] __initdata = {
	...
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(15),  937500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(15),  950000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(15),  962500 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(15),  987500 },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(15), 1012500 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(15), 1037500 },
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(15), 1037500 },
