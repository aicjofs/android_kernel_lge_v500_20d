...
#define OVERCLOCK_EXTRA_FREQS	1
#else
...
int g_pvs_bin;
		...
		|| defined(CONFIG_MACH_APQ8064_GVDCM) || defined(CONFIG_MACH_APQ8064_GV_KR) || defined(CONFIG_MACH_APQ8064_GKGLOBAL) || defined(CONFIG_MACH_APQ8064_OMEGAR_KR)
int limit_cpufreq = 0;
#endif
